...
public class Constans {
    ...
    public static void init() {
        ...
        resourceMap.put(7, new ResourceBean(false,"购物", R.mipmap.s7));
        ...
        resourceMap.put(13, new ResourceBean(false,"搬货", R.mipmap.s13));
        ...
        resourceMap.put(17, new ResourceBean(false,"文具", R.mipmap.s17));
        resourceMap.put(18, new ResourceBean(false,"加油", R.mipmap.s18));
        resourceMap.put(19, new ResourceBean(false,"水费", R.mipmap.s19));
        ...
        resourceMap.put(27, new ResourceBean(false,"电影", R.mipmap.s27));
        resourceMap.put(28, new ResourceBean(false,"生日", R.mipmap.s28));
        resourceMap.put(29, new ResourceBean(false,"游乐场", R.mipmap.s29));
        resourceMap.put(30, new ResourceBean(false,"健身", R.mipmap.s30));
        ...
        resourceMap.put(35, new ResourceBean(false,"烧烤", R.mipmap.s35));
